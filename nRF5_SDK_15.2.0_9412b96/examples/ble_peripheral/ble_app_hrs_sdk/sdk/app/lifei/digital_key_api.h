...
extern int ingeek_write_flash();

extern int ingeek_SaveCalibration();
extern int ingeek_SetPSCalibration(const unsigned char * bleMac,unsigned char psvalue,unsigned char pevalue);
extern int ingeek_GetPSCalibration(const unsigned char * bleMac,unsigned char *psvalue,unsigned char *pevalue);
