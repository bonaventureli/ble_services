#ifndef INGEEK_ASN1_WRITE_H
#define INGEEK_ASN1_WRITE_H
...
#define INGEEK_ASN1_CHK_ADD(g, f) do { if( ( ret = f ) < 0 ) return( ret ); else   \
                                g += ret; } while( 0 )
...
/**
 * \brief           Write a big number (INGEEK_ASN1_INTEGER) in ASN.1 format
 ...
 * \return          the length written or a negative error code
 */
int ingeek_asn1_write_tag( unsigned char **p, unsigned char *start,
                    unsigned char tag );
...
/**
 * \brief           Write a NULL tag (INGEEK_ASN1_NULL) with zero data in ASN.1 format
 *                  Note: function works backwards in data buffer
 *
 * \param p         reference to current position pointer
 * \param start     start of the buffer (for bounds-checking)
...
/**
 * \brief           Write an OID tag (INGEEK_ASN1_OID) and data in ASN.1 format
 *                  Note: function works backwards in data buffer
 *
 * \param p         reference to current position pointer
 * \param start     start of the buffer (for bounds-checking)
...
/**
 * \brief           Write a boolean tag (INGEEK_ASN1_BOOLEAN) and value in ASN.1 format
 *                  Note: function works backwards in data buffer
 *
 * \param p         reference to current position pointer
 * \param start     start of the buffer (for bounds-checking)
...
/**
 * \brief           Write an int tag (INGEEK_ASN1_INTEGER) and value in ASN.1 format
 *                  Note: function works backwards in data buffer
 *
 * \param p         reference to current position pointer
 * \param start     start of the buffer (for bounds-checking)
...
/**
 * \brief           Write a printable string tag (INGEEK_ASN1_PRINTABLE_STRING) and
...
/**
 * \brief           Write an IA5 string tag (INGEEK_ASN1_IA5_STRING) and
 *                  value in ASN.1 format
 *                  Note: function works backwards in data buffer
 *
 * \param p         reference to current position pointer
...
/**
 * \brief           Write a bitstring tag (INGEEK_ASN1_BIT_STRING) and
 *                  value in ASN.1 format
 *                  Note: function works backwards in data buffer
 *
 * \param p         reference to current position pointer
...
/**
 * \brief           Write an octet string tag (INGEEK_ASN1_OCTET_STRING) and
 *                  value in ASN.1 format
 *                  Note: function works backwards in data buffer
 *
 * \param p         reference to current position pointer
 ...
 */
ingeek_asn1_named_data *ingeek_asn1_store_named_data( ingeek_asn1_named_data **list,
                                        const char *oid, size_t oid_len,
